...
def respond_ai(message, history):
    ...
    while message.tool_calls:  #while needed when model cant do parallel tool calls
        pprint (message.tool_calls) #--debugging
        ...
        message = response.choices[0].message
        #Note: maybe consider adding protection from infinte consecutive tool calling
